...
void main()
{
	//Get the pixel value at the current location from the build-in Cocos2d uniform "CC_Texture0"
	vec4 v_orColor = v_fragmentColor * texture2D(CC_Texture0, v_texCoord);
	//v_texCoord is the current location/. Get the distance to the "loc" univorm we have defined
